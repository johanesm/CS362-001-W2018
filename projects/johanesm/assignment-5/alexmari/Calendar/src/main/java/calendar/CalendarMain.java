...
public class CalendarMain {
	public static void main(String[] args) throws DateOutOfRangeException {
      ...
      // create another appointment
		...
		if(diagnose){
			System.out.println("Permutated List \n");
			timeTable.permute(listAppts,a);
			LinkedList<Appt> permuteAppt = new LinkedList<Appt>();
			permuteAppt = timeTable.permute(listAppts, a);
			System.out.println(permuteAppt.toString());
		}
