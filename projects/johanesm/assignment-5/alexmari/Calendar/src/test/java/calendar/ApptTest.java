...
public class ApptTest {
	...
	//	 assertEquals(null, appt.getRecurDays());
	     ...
	     appt.setStartHour(11);	//this is an issue when the start hour is 11, but not when i try 10
	   ...
	   //  assertTrue(compare.equals(compare_2));	   //TODO: uncomment this
	 ...
	 @Test
	  public void test04()  throws Throwable  { 
		 int startHour=23;	//changed to 22 to see if boundry condition is the issue (it is)	//this is allowed and valid
		 int startMinute=30;
		 int startDay=15;
		 int startMonth=01;
		 int startYear=2018;
		...
		// assertTrue(appt.getValid());	//TODO: uncomment this
		 appt.setStartHour(0);
	//	 assertTrue(appt.getValid());	//TODO: uncomment this
		 appt.setStartHour(-1);
		 assertFalse(appt.getValid());		 
	...
	//	 assertFalse(appt.getValid()); TODO: uncomment this
