...
public class ApptRandomTest {
    ...
    public static String RandomSelectMethod(Random random){
        String[] methodArray = new String[] {"setTitle","setRecurrence","setRecurrenceNull"};// The list of the of methods to be tested in the Appt class
	  ...
	  public void radnomtest()  throws Throwable  {
		...
		try{ 
			for (int iteration = 0; elapsed < TestTimeout; iteration++) {
				...
				Random random = new Random(randomseed);
				 ...
				 int startYear=ValuesGenerator.getRandomIntBetween(random, -4000, 4000);
		 ...
		 */
			...
			for (int i = 0; i < NUM_TESTS; i++) {
				...
				//		   assertTrue(newTitle.equals(appt.getTitle()));
						}
